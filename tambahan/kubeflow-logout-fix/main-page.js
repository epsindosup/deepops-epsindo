...
export class MainPage extends utilitiesMixin(PolymerElement) {
    ...
    _routePageChanged(newPage, path, hashPath) {
        ...
        switch (newPage) {
        case 'logout':
            window.top.location.href = 'https://auth.ipb.ac.id/auth/realms/Advancedlab/protocol/openid-connect/logout?post_logout_redirect_uri=https%3A%2F%2Fkubeflow.ipb.ac.id/logout';
            break;
        case 'activity':
            this.page = 'activity';
            hideTabs = false;
